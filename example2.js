...
class Todo extends React.Component  {
    ...
    render(){
        const styleName = (this.props.item.completed ? todoStyleCompleted :todoStyle);
        console.log('render called');
        return (
        <li title="xx" style={styleName} onClick={()=> this.props.deleteItem(this.props.item.id) }>
